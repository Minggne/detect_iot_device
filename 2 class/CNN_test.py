...
combined_directory = 'D:\detection_server_using_payload_TCP_2_class\data'
train_directory = r'D:\detection_server_using_payload_TCP_2_class\model\train'
test_directory = r'D:\detection_server_using_payload_TCP_2_class\model\test'
