...
pcap_directory = 'E:\Downloads\detection_server_using_payload_TCP\google_home_pcap\media_pcap_anonymized'
output_directory = r'E:\Downloads\detection_server_using_payload_TCP\ttttt\media_pcap_anonymized_csv' 
max_packets = 350
...
for pcap_file in os.listdir(pcap_directory):
    if pcap_file.endswith('.pcap'):  
        ...
        output_csv = os.path.join(output_directory, pcap_file.replace('.pcap', '_tcp_features_non_Amazon.csv'))
