...
def evaluate_model(amazon_dir, google_dir, other_dir, output_excel_path):
    """Evaluate model on Amazon, Google, and Other directories and save results to Excel."""
    ...
    google_results = predict_category_folder(google_dir, label=1)

    # Predict for Other category (class 2)
    other_results = predict_category_folder(other_dir, label=2)

    # Combine results into a DataFrame
    all_results = amazon_results + google_results + other_results
...
amazon_folder = r'E:\Downloads\detection_server_using_payload_TCP\danhgia_device\Amazon'
google_folder = r'E:\Downloads\detection_server_using_payload_TCP\danhgia_device\Google'
other_folder = r'E:\Downloads\detection_server_using_payload_TCP\danhgia_device\non_Amazon'
output_excel_path = r'E:\Downloads\detection_server_using_payload_TCP\device_predictions.xlsx'

# Run evaluation and save to Excel
confusion_mat, classification_rep = evaluate_model(amazon_folder, google_folder, other_folder, output_excel_path)
